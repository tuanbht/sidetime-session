...
function App(props: AppProps) {
  const {
    meetingArgs: { topic, signature, name, password, enforceGalleryView },
    applicationProviderValue
  ...
  const applicationContextValue = useMemo(
    () => ({ ...applicationProviderValue, handleClickChatButton }),
    [applicationProviderValue, handleClickChatButton]
  );
          ...
          <ZoomMediaContext.Provider value={mediaContext}>
            ...
            {!loading && (
              <>
                ...
                <ChatContainer openSessionChat={openSessionChat} />
              </>
            )}
